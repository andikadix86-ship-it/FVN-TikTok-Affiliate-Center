...
const verificationSignature = "tiktok-developers-site-verification=vrKp9Y09D82pP3aEGPGfXBK2AWD9jihE";
        ...
        <div className="mx-auto max-w-3xl rounded-[2rem] border border-line bg-white p-6 shadow-soft sm:p-8">
          ...
          <div className="mt-6 space-y-5 text-sm leading-7 text-muted">
            ...
            <section>
              ...
              <p>
                For privacy questions, contact: <a href="mailto:andikadix86@gmail.com" className="font-semibold text-ink underline">andikadix86@gmail.com</a>
              </p>
            </section>
          </div>
