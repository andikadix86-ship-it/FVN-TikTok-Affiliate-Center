    ...
    <section id="dashboard" className="space-y-6">
      ...
      {hasDemoProducts ? (
        <div className="rounded-[1.5rem] border border-amber-200 bg-amber-50 p-4">
          <p className="text-sm font-black text-amber-950">DEMO</p>
                  ...
                  <article key={product.id} className="grid gap-3 rounded-[1.5rem] border border-line bg-slate-50 p-3 transition hover:border-violet-200 hover:bg-violet-50/50 sm:grid-cols-[44px_72px_1fr_auto] sm:items-center">
                    ...
                    <div className="min-w-0">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {product.source === "DEMO" ? <span className="rounded-full bg-amber-100 px-2.5 py-1 text-[10px] font-black text-amber-900">DEMO</span> : null}
                      </div>
  ...
  return (
    <aside className="space-y-5 xl:sticky xl:top-24 xl:self-start">
      <section id="profit-center-widget" className="rounded-[2rem] border border-white bg-white p-5 shadow-soft">
        ...
        {isDemoOnly ? <p className="mt-3 rounded-2xl bg-amber-50 p-3 text-xs font-bold text-amber-900">Marketplace API belum terhubung. Data ini masih contoh.</p> : null}
